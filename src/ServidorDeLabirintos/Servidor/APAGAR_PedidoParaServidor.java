...
/**
 * Recebe a operação do cliente e envia o objeto (labirinto) do servidor para o
 * cliente.
 */
public class APAGAR_PedidoParaServidor {

    // No caso do servidor de continhas, é mandado a operacao e o valor, mas no
    // nosso programa, vamos
    // pedir opcoes do usuario:

    // - Criar novo labirinto do zero -> Vai para a interface, ele é criado e depois
    // deve ser salvo pelo novo botao "Salvar no Server"
    ...
    public APAGAR_PedidoParaServidor(char Operacao, String labirinto) {
